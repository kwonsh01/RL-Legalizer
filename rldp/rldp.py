...
class via(object):
    ...
    propertys = property(_RL_Legalizer.via_propertys_get, _RL_Legalizer.via_propertys_set)
...
class instance(object):
    ...
    def get_x_coord(self):
        return _RL_Legalizer.instance_get_x_coord(self)

    def get_y_coord(self):
        return _RL_Legalizer.instance_get_y_coord(self)

    def get_width(self):
        return _RL_Legalizer.instance_get_width(self)

    def get_moveTry(self):
        return _RL_Legalizer.instance_get_moveTry(self)

    def getGcellXcoord(self, Gcell_grid, rx):
        return _RL_Legalizer.instance_getGcellXcoord(self, Gcell_grid, rx)

    def getGcellYcoord(self, Gcell_grid, ty):
        return _RL_Legalizer.instance_getGcellYcoord(self, Gcell_grid, ty)
...
class RLDP(circuit):
    ...
    def reward_calc(self):
        return _RL_Legalizer.RLDP_reward_calc(self)

    def reward_calc_Gcell(self, gcell_id):
        return _RL_Legalizer.RLDP_reward_calc_Gcell(self, gcell_id)

    def calc_HPWL(self):
        return _RL_Legalizer.RLDP_calc_HPWL(self)

    def calc_avg_disp(self):
        return _RL_Legalizer.RLDP_calc_avg_disp(self)

    def get_Gcell_grid(self):
        return _RL_Legalizer.RLDP_get_Gcell_grid(self)

    def total_cell_num(self):
        return _RL_Legalizer.RLDP_total_cell_num(self)

    def get_die_rx(self):
        return _RL_Legalizer.RLDP_get_die_rx(self)

    def get_die_ty(self):
        return _RL_Legalizer.RLDP_get_die_ty(self)

    def get_die_rH(self):
        return _RL_Legalizer.RLDP_get_die_rH(self)

    def calc_done(self):
        return _RL_Legalizer.RLDP_calc_done(self)

    def calc_Gcell_done(self, runtime_gcell):
        return _RL_Legalizer.RLDP_calc_Gcell_done(self, runtime_gcell)
